...
use Phlex\Core\Exception as ClassWithWarnDynamicPropertyTrait;
...
class WarnDynamicPropertyTraitTest extends TestCase
{
    ...
    public function testIssetException(): void
    {
        ...
        $this->runWithErrorConvertedToException(function () {
            ...
            $this->expectExceptionMessage('Undefined property: Phlex\Core\Exception::$xxx');
    ...
    public function testGetSetPublicProperty(): void
    {
        ...
        $this->runWithErrorConvertedToException(function () use ($test) {
            $this->expectException(WarnError::class);
            $this->expectExceptionMessage('Undefined property: Phlex\Core\Exception@anonymous::$p');
    ...
    public function testGetProtectedPropertyException(): void
    {
        ...
        $this->expectExceptionMessage('Cannot access protected property Phlex\Core\Exception::$customExceptionTitle');
    ...
    public function testGetPrivateProperty(): void
    {
        $this->runWithErrorConvertedToException(function () {
            ...
            $this->expectException(WarnError::class);
            $this->expectExceptionMessage('Undefined property: Phlex\Core\Exception::$trace');
