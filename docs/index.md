...
[Phlex UI](https://github.com/atk4/ui) and [Phlex Data](https://github.com/atk4/data),
...
doInitialize() method, carry over $app and set $owner properties and calculate 'name'
...
for tracking render tree in Phlex UI where name is optional and a unique name
is guaranteed.
...
- {php:trait}`InjectableTrait` will let you with dependency injection
...
```
$field = $form->add([\Phlex\Ui\FormField\Password::class, 'icon' => ['lock', 'circular inverted'], 'width' => 4);
```
...
[Phlex Data](https://github.com/atk4/data) features a modern implementation
for object modeling.
...
```
class ShoppingBag extends \Phlex\Data\Model
{
...
[Phlex UI](https://github.com/atk4/ui) implements UI Components that can be
