...
- `$object->elementName` == "app_object_4"
- `$anotherObject->elementName` == "app_object_4_test"
...
Phlex maintainers agreed to gradually refactor Phlex Data to use CollectionTrait
...
$parent->elementName = 'foo';
$parent->add(new MyItem(), 'child1');
$parent->add(new MyItem());

echo $parent->getElement('child1')->elementName;
// foo_child1
...
If you pass 'desiredName' => 'heh' to a constructor, then it will affect the
